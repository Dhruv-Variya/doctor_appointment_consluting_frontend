...
function Drdone() {
    ...
    const fetchdoctor = async () => {
        ...
        const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/finddoneappointmentofdoctor`, myDecodedToken.user);
                                        ...
                                        <div class="card my-4">
                                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                                    <h6 class="text-white text-capitalize ps-3">My Done requestes</h6>
                                                </div>
                                            </div>
                                                                ...
                                                                doctor.map(doctor => (
                                                                    <>
                                                                        <tr >
                                                                            ...
                                                                            {/* <td class="align-middle text-center text-sm">
                                                                                <button class="btn badge badge-sm btn-success" value={doctor.email} type="button" >✔</button>
                                                                            </td>
                                                                            <td class="align-middle text-center text-sm">

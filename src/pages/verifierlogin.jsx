...
const Verlogin = () => {
  ...
  const submit = async e => {
    if (verifierdetails.email == "" || verifierdetails.password == "") {
      ...
      await axios.post(`${process.env.REACT_APP_BASE_URL}/verifierlogin`, verifierdetails).then((res) => {
        //console.log(res);
        if (res.data.message === "ok") {
          localStorage.setItem('verifiertoken', res.data.token);
          toast.success("login Successful");
          setTimeout(() => {
            navigate('/verifierdash');
          }, 1200)
                ...
                <div class=" px-xl-5">
                  <div class="lead_magnet_form_wrapper">
                    <div class="form_title">
                      <h4 class="sub_heading">Verifier Login :</h4>
                    ...
                    <div id="">
                      ...
                      <br />
                      <Link style={{ textDecoration: "none" }} to="/adminlogin">Are you an admin ?</Link>
                    </div>
